...
public class QoSAddClass {

    private String ovsdbDeviceId = "ovsdb:195.148.125.107";
    private String id = null;
    private String portnumber = null;
    private String minRate = null;
    private String maxRate = null;
    private String burst = null;
    int dscp = 0; // low priority by default
    long priority = 7; // lowest priority by default


    public QoSAddClass(String id, String portnumber, String minrate, String maxrate, String burst ,long priority, int dscp){
                        this.id=id;
    ...
    protected QosDescription qosDescCreator(String name, Map <Long, QueueDescription> longerQueues){
        QosDescription qosDescription = DefaultQosDescription.builder()
                ...
                .maxRate(Bandwidth.bps(Long.valueOf("1000000")))
                .queues(longerQueues)
                .build();
    ...
    protected void execute() {
        ...
        QueueDescription queueDesc = DefaultQueueDescription.builder()
                ...
                .maxRate(Bandwidth.bps(Long.parseLong(maxRate)))
                .minRate(Bandwidth.bps(Long.valueOf(minRate)))
