...
@Service
@Command(scope = "onos", name = "queue-del",
        description = "Qos Test.")
public class QueueDelCommand extends AbstractShellCommand {

    @Argument(index = 0, name = "ovsdbDeviceId", description = "the ovsdb TYPE id.", required = true,
            multiValued = false)
    String ovsdbDeviceId = null;

    @Argument(index = 1, name = "queue id", description = "queue id.", required = true,
            multiValued = false)
    String id = null;
	...
	// Deleting all the queueus related to the specified QoS
